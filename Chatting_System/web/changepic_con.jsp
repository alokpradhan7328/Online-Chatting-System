...
//    String absolutePath = getServletContext().getRealPath("/profile_picture");
    MultipartRequest m = new MultipartRequest(request,"G:/Projects/Chatting_System/web/profile_picture",8*1024*1024);
    ...
    while(files.hasMoreElements()){
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/chat_system","root","12345");
