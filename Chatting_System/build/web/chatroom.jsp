            ...
            <div class="container3">
                <section class="chat-area">
                    <header>
                        <%
                            ...
                            try{
                                ...
                                con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/chat_system","root","12345");
                    ...
                    <div class="chat-box">
                        ...
                        <sql:setDataSource driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/chat_system" user="root" password="12345" var="fetch"></sql:setDataSource>
